    ...
    <section className="space-y-4">
      ...
      >
        ...
        <div className="flex gap-3 pt-1">
          <Link
            href="/admin/ships"
            className="rounded-xl border-2 border-black bg-white px-4 py-2 text-sm font-semibold shadow-[3px_3px_0_0_#111] transition-all hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none"
          >
            Cancelar
          </Link>
